...
def register_dentex_quadrant_dataset():
    ...
    register_coco_instances(
        "chest_train",
        {},
        "dentex_dataset/coco/Chest-Xray/instances_train2017.json",
        "dentex_dataset/coco/Chest-Xray/train2017",
    )
    register_coco_instances(
        "chest_val",
        {},
        "dentex_dataset/coco/Chest-Xray/instances_val2017.json",
        "dentex_dataset/coco/Chest-Xray/val2017",
    )
    ...
    register_coco_instances(
        "skin_train",
        {},
        "dentex_dataset/coco/skin_cancer/instances_train2017.json",
        "dentex_dataset/coco/skin_cancer/train2017",
    )
    register_coco_instances(
        "skin_val",
        {},
        "dentex_dataset/coco/skin_cancer/instances_val2017.json",
        "dentex_dataset/coco/skin_cancer/val2017",
    )

    register_coco_instances(
        "skin_train_1label",
        {},
        "dentex_dataset/coco/skin_cancer/instances_train2017_1label.json",
        "dentex_dataset/coco/skin_cancer/train2017",
    )
    register_coco_instances(
        "skin_val_1label",
        {},
        "dentex_dataset/coco/skin_cancer/instances_val2017_1label.json",
        "dentex_dataset/coco/skin_cancer/val2017",
    )
    ...
    register_coco_instances(
        "skin64_train",
        {},
        "dentex_dataset/coco/skin64/instances_train2017.json",
        "dentex_dataset/coco/skin64/train2017",
    )
    register_coco_instances(
        "skin64_val",
        {},
        "dentex_dataset/coco/skin64/instances_val2017.json",
        "dentex_dataset/coco/skin64/val2017",
    )

    register_coco_instances(
        "skin73_train",
        {},
        "dentex_dataset/coco/skin73/instances_train2017.json",
        "dentex_dataset/coco/skin73/train2017",
    )
    register_coco_instances(
        "skin73_val",
        {},
        "dentex_dataset/coco/skin73/instances_val2017.json",
        "dentex_dataset/coco/skin73/val2017",
    )

    register_coco_instances(
        "skin91_train",
        {},
        "dentex_dataset/coco/skin91/instances_train2017.json",
        "dentex_dataset/coco/skin91/train2017",
    )
    register_coco_instances(
        "skin91_val",
        {},
        "dentex_dataset/coco/skin91/instances_val2017.json",
        "dentex_dataset/coco/skin91/val2017",
    )

    # lung train: 1920, test: 474
    register_coco_instances(
        "lung_train",
        {},
        "/data/xinyuan/yangqi/Deepleision/annotations/deep_leision_lung_train.json",
        "/data/xinyuan/yangqi/Deepleision/lung_img",
    )
    register_coco_instances(
        "lung_val",
        {},
        "/data/xinyuan/yangqi/Deepleision/annotations/deep_leision_lung_test.json",
        "/data/xinyuan/yangqi/Deepleision/lung_img",
    )
