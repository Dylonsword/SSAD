...
from models.auxiliaryHead import MAEHead, CLIPLoss, SamExtractor, get_params_group
...
train.output_dir = "train_out/quadrant/faster_rcnn/vitdet-ssat-medsam"
...
clip_params = dict(
    ...
    sam_size="vit_b",
    neck=False,
    sam_checkpoint="/data/xinyuan/tooth_disease_detection/3dSeg/segment-anything/sam_vit_b_01ec64.pth",
    struc_lambda=1, # drop
    distri_lambda=1,
)
