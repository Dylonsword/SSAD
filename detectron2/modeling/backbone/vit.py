...
def build_vit_backbone(cfg, input_shape: ShapeSpec):
    config = size2config[cfg.MODEL.VITDET.SIZE]
...
def build_vitdet_backbone(cfg, input_shape: ShapeSpec):
    ...
    in_features = net.out_feature
    out_channels = cfg.MODEL.VITDET.OUT_CHANNELS
    scale_factors = cfg.MODEL.VITDET.SCLAE_FACTOR
    square_pad = cfg.MODEL.VITDET.SQUARE_PAD
    norm = cfg.MODEL.VITDET.NORM
