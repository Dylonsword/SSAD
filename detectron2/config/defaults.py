...
# ---------------------------------------------------------------------------- #
_C.MODEL.VITDET = CN()
_C.MODEL.VITDET.SIZE = "B"  # B, L
_C.MODEL.VITDET.OUT_CHANNELS = 256
_C.MODEL.VITDET.SCLAE_FACTOR = [4.0, 2.0, 1.0, 0.5]
_C.MODEL.VITDET.SQUARE_PAD = 512
_C.MODEL.VITDET.NORM = "LN"
# ---------------------------------------------------------------------------- #
# Solver
# ---------------------------------------------------------------------------- #
_C.SOLVER = CN()
